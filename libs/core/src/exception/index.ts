...
import { ErrorCustom, ErrorValues } from '../../../constants/enum';
...
export class CustomWsExceptionFactory extends WsException {
  constructor(errorValue: ErrorValues, devMessage?: string | any, statusCode?: HttpStatus, payload?: any) {
    const errorObject = {
      errorValue,
      statusCode: statusCode || HttpStatus.BAD_REQUEST,
...
export class WsExceptionNew extends CustomWsExceptionFactory {
  /**
   *
   * @example
   *
   ...
   *   throw Exception("Something_Went_Wrong", "This is error description", HttpStatus.BAD_REQUEST, { isSystem: true })
   */
  constructor(errorValue: ErrorValues, devMessage?: string | any, payload?: any) {
    super(errorValue, devMessage, payload);
  }
}
...
export class Forbidden extends CustomExceptionFactory {
  ...
  constructor(devMessage?: string | any, payload?: any) {
    super(ErrorCustom.Forbidden_Resource, devMessage, HttpStatus.FORBIDDEN, payload);
  }
}
...
export class Unauthorized extends CustomExceptionFactory {
   ...
   */
  constructor(devMessage?: string | any, payload?: any) {
    super(ErrorCustom.Unauthorized, devMessage, HttpStatus.UNAUTHORIZED, payload);
  }
}
...
export class UnprocessableEntity extends CustomExceptionFactory {
   ...
   */
  constructor(devMessage?: string | any, payload?: any) {
    super(ErrorCustom.Invalid_Input, devMessage, HttpStatus.UNPROCESSABLE_ENTITY, payload);
  }
}
