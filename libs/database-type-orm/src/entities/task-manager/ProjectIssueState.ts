...
import { ProjectIssueStateStatus } from '../../../../constants/enum';

@Entity('project_issue_state')
export default class ProjectIssueState {
  ...
  @Column({
    ...
    type: 'tinyint',
    unsigned: true,
    default: ProjectIssueStateStatus.ACTIVE,
  })
  ...
  /* -------------------------------- relation ------------------------------- */
  @ManyToOne(() => Project, (project) => project.projectIssueStates)
